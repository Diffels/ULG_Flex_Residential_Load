...
#Define the inner class for modelling user's appliances within the correspoding user class
    class Appliance():
        ...
        def __init__(self,user, n = 1, Par_power = [0, 0, 0], Battery_cap = 0, P_var = 0, w = 1, t_func = 0, d_tot = 0, r_d = 0, r_v = 0, d_min = 1, fixed = 'no', fixed_cycle = 0, occasional_use = 1, flat = 'no',  pref_index = 0, wd_we_type = 3, P_series = False, day_type='weekday'):
            ...
            self.day_type = day_type # Modification: an appliance is linked to a type of day ['weekday', 'saturday', 'sunday']
